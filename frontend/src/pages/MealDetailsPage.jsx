...
function MealDetailsPage() {
  ...
  const handleToggleFollowChef = async () => {
    try {
      ...
      if (!token || !savedUser) {
        setErrorMessage("Please login as a customer to follow chefs.");
        return;
      }
      ...
      if (!meal?.chef?.id) {
        setErrorMessage("Chef information is not available.");
        return;
      }
              ...
              <div className="overflow-hidden rounded-[36px] border border-slate-200 bg-white shadow-sm shadow-slate-200/70">
                ...
                <div className="p-6 sm:p-8">
                  <div className="flex flex-wrap gap-3">
                    ...
                    <span className="badge-soft">Chef-managed delivery</span>
                ...
                <div className="panel-soft">
                  ...
                  <div className="mt-6 grid gap-3">
                    <div className="grid gap-3 sm:grid-cols-2">
                      ...
                      <Link to="/order" className="btn-secondary text-center">
                        Go to Cart
                      </Link>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-slate-500">
                          {meal.chef?.serviceArea || "Nearby local area only"}
                        </p>
                      </div>
                    </div>
                  </div>
